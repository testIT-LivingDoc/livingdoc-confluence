...
public class BankFixture {
	...
	public Money theBalanceOfAccount(String number)
	...
	@Alias("openCheckingAccountWithAccountHolder")
	public boolean openCheckingAccountUnderTheNameOf(String number,
			String firstName, String lastName) {
		return bank.openCheckingAccount(number, new Owner(firstName, lastName)) != null;
	}

	@Alias("openAccountWithAccountHolder")
	public boolean openAccountUnderTheNameOf(AccountType type, String number,
			String firstName, String lastName) {
		if (AccountType.SAVINGS == type) {
			...
			return openCheckingAccountUnderTheNameOf(number, firstName,
					lastName);
		}
		return false;
	}
	...
	@Alias("withdrawAmountOfInAccountUsing")
	public boolean withdrawFromAccountUsing(Money amount, String accountNumber,
			WithdrawType withdrawType) throws Exception {
		try {
